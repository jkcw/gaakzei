<?php
  ...
  if (!mysqli_stmt_prepare($comment_stmt, $comment_sql)) {
    ...
    mysqli_stmt_bind_param($comment_stmt, "ii", $goodsID, $start);
  ...
  /*===================================================================================*/
        ...
        for ($i=0; $i < $imgQuantity; $i++) {
          $comment_img_output .= '<img class="comment-img" alt="'.$commentContent.'" id="'.$i.'" src="comment-img/comment-'.$goodsID.'-'.$CuserID.'-'.$i.'.jpg" />';
        }
