<?php 
    ...
    /* some function */
    function colorScore($fnc_rating) {
        ...
        if ($fnc_rating == 100) {
          ...
          } elseif ($fnc_rating >= 80 && $fnc_rating < 100) {
          ...
          } elseif ($fnc_rating >= 50 && $fnc_rating < 80) {
          ...
          } elseif ($fnc_rating >= 25 && $fnc_rating < 50) {
          ...
          } elseif ($fnc_rating >= 0 && $fnc_rating < 25) {
    ...
    /*get the avg rating of the user and demonstrate on the user's profile page*/
    ...
    /* Binding */
        ...
        if ($totalComment == 0) {
            ...
            $score_icon = colorScore($avgRating);
